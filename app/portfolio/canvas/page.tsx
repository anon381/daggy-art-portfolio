...
export default function CanvasPortfolioPage() {
	...
	const [typeFilter, setTypeFilter] = useState("canvas")
			...
			<main className="container py-12">
				<div className="space-y-6">
					<div className="space-y-2">
						<h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-earth">Canvas Paintings</h1>
						<p className="text-muted-foreground">A selection of original canvas paintings available for commissions or sale.</p>
					</div>
